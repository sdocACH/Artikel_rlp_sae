...
% NOTE:
% - add table with overview of terrestrial dta attributes (like Johannes)
%
...
\begin{figure}[H]
	\centering
	\resizebox{0.63\hsize}{!}{\includegraphics*{fig/SAunitsRLP.png}}
...
%\begin{table}[H]
%	\begin{center}
%		\caption{Sample size for each phase in entire study area.}
%		\label{tab:ssize}
%		\begin{tabular}{l|r|r|r|r}
%			\hline
%			\textit{Sampling frame} & \textbf{$n_{1,plot}$} & \textbf{$n_1$} & \textbf{$n_{2,plot}$} & \textbf{$n_2$}\\ % <-- added & and content for each column
%			\hline \hline
%			communal and state forest & 96'854 & 33'365 & 5791 & 2055\\ % <--
%			\hspace{5mm} \small missing CHM & \small 16 & \small 9 & \small 0 & \small 0\\ % <--
%			\hspace{5mm} \small missing TSPEC & \small 6910  & \small 3465 & \small 407 & \small 380\\ % <--
%			\hspace{5mm} \small missing CHM \textit{and} TSPEC & \small 2 & \small 1 & \small 0 & \small 0\\ % <--
%			\hspace{5mm} \small missing CHM \textit{or} TSPEC & \small 6924 & \small 3473 & \small 407 & \small 380\\ % <--
%			\hline
%			Total for estimation & 89'930 & 29'892 & 5384 & 1675\\ % <--			
%		\end{tabular}
%	\end{center}
%\end{table}
...
\begin{table}[H]
	...
	\label{tab:classacc}
 {\small %
	\begin{tabular}{c|c|c|c|c|c|c|c} %8cols
		\hlineB{1}
...
% ---------------------------------------------- %
\subsubsection{Design-Based Model Inference}
\label{sec:edbinf}
